        ...
        <RevealOnScroll variant="up">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-muted-foreground text-lg max-w-2xl mx-auto">
              Leaders across Maryland are standing with Michele W. Johnson.
            </p>
          </div>
        </RevealOnScroll>
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {endorsements.map((e, i) => (
            <RevealOnScroll key={e.name} variant="scale" delay={i * 100}>
              <Card className="w-64 text-center shadow-sm">
                <CardContent className="pt-8 pb-6 px-6">
                  <div className="mx-auto mb-4 flex size-16 items-center justify-center rounded-full bg-primary/10 text-primary font-bold text-xl font-heading">
                    {e.initials}
                  </div>
